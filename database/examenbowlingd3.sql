...
(2, 2, 2, 2, 1, 'Bevestigd', '2022122000002', '2022-12-20', 1, '17:00', '18:00', 4, NULL),
(3, 3, 2, 3, 3, 'Bevestigd', '2022122400003', '2022-12-24', 2, '16:00', '18:00', 4, NULL),
(4, 4, 2, 4, NULL, 'Bevestigd', '2022122700004', '2022-12-27', 2, '17:00', '19:00', 2, NULL),
(5, 5, 2, 5, 1, 'Bevestigd', '2022122800005', '2022-12-28', 1, '14:00', '15:00', 3, NULL),
(6, 5, 2, 6, 1, 'Bevestigd', '2022122800006', '2022-12-28', 2, '19:00', '21:00', 2, NULL);

-- Verwijder bestaande tabel als die er is
DROP TABLE IF EXISTS `baan`;

-- Maak nieuwe tabel 'baan' aan
CREATE TABLE IF NOT EXISTS `baan` (
  `Id` INT NOT NULL,
  `Nummer` INT NOT NULL,
  `heeftHek` TINYINT(1) NOT NULL DEFAULT 0, -- 1 = ja, 0 = nee
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Testdata voor tabel 'baan'
