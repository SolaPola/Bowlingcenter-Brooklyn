                ...
                <div class="p-6">
                        ...
                        <table class="min-w-full bg-white border border-gray-200 rounded-lg overflow-hidden">
                            ...
                            <tbody class="text-gray-800 text-sm font-light">
                                <tr class="border-b border-gray-200 hover:bg-gray-50">
                                    <td class="py-3 px-6 text-left font-medium">Huidige Score:</td>
                    ...
                    <div class="mt-6 flex justify-start">
                        <a href="{{ route('score.index') }}"
                            class="px-6 py-2.5 bg-yellow-500 hover:bg-yellow-600 text-white rounded-md transition duration-200 ease-in-out flex items-center">
