                ...
                <form action="{{ route('order.update', $order->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="orderNumber" id="orderNumber" value="{{ $order->orderNumber }}" 
                        ...
                        <div class="mb-4">
                            ...
                            <select name="packageType" id="packageType" 
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                <option value="Basic" {{ $order->packageType == 'Basic' ? 'selected' : '' }}>Basic</option>
                                <option value="Premium" {{ $order->packageType == 'Premium' ? 'selected' : '' }}>Premium</option>
                                <option value="VIP" {{ $order->packageType == 'VIP' ? 'selected' : '' }}>VIP</option>
                            </select>
                        </div>
                    </div>
