    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div class="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4">
                ...
                <a href="{{ route('reservation_klant.index') }}" class="bg-blue-600 text-white px-5 py-3 rounded-md transition duration-300 hover:bg-green-700 transform hover:scale-105">Terug naar Overzicht</a>
            </div>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('reservation_klant.store') }}">
                        @csrf
                        ...
                        <div class="flex items-center justify-between mt-6">
                            <a href="{{ route('reservation_klant.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                                Annuleren
                            </a>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function checkAvailability() {
            ...
            fetch(`/reservation_klant/check-availability?date=${date}&timeslotId=${timeslotId}`, {
                headers: {
